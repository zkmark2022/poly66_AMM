"""Shared factory helpers for Layer 3 simulation tests.

Provides lightweight builder functions so individual test files can compose
test scenarios without duplicating mock setup.

Import explicitly from this module:
    from tests.simulation.helpers import make_config, make_context, ...
"""
