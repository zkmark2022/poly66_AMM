...
def _make_api_pair(client: httpx.AsyncClient) -> tuple[TokenManager, AMMApiClient]:
    """Create a TokenManager + AMMApiClient sharing a single httpx client."""
    tm = TokenManager(base_url=BASE_URL, username="", password="", client=client)
    tm.access_token = "preset_token"  # bypass login
